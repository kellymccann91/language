...
Natalie Catlett <info@openbel.org>
v2.0, 2014-06
:toc: right
:toclevels: 4
...
_Please cite the BEL v2.0 language documentation as "BEL v2.0 Language Documentation, https://github.com/OpenBEL/language ", along with the date accessed._
